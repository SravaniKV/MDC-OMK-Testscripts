...
class Employee_Login(unittest.TestCase):
   ...
   def test_Login_user(self):
       ...
       elem.send_keys("Goutham")
       elem = driver.find_element_by_id("id_password")
       elem.send_keys("gtham12345")
   ...
   def test_Add_students(self):
       ...
       #Click Add Student
       elem = driver.find_element_by_xpath("/html/body/div[1]/div/div/div/div/div/a/span").click()
   ...
   def test_Log_out(self):
       ...
       elem.send_keys("gtham12345")
       driver.find_element_by_xpath("//button[contains(.,'Submit')]").click()
       driver.find_element_by_partial_link_text("Hello Goutham").click()
       #time.sleep(10)
