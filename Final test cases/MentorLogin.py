...
class OMK_Mentorlogin(unittest.TestCase):
   ...
   def test_mark_attendance(self):
       ...
       #Mark Attendance
       elem = driver.find_element_by_xpath("/html/body/div[1]/nav/div[2]/ul/li[2]/a").click()
       elem = driver.find_element_by_xpath("/html/body/div[1]/div/div/div/div/div/table/tbody/tr[1]/td[3]/a").click()
       ...
       elem = driver.find_element_by_xpath("/html/body/div[1]/div/div/form/button").click()

       # Click Student List
       elem = driver.find_element_by_xpath("/html/body/div[1]/nav/div[2]/ul/li[3]/a").click()
   ...
   def test_edit_student(self):
       ...
       elem = driver.find_element_by_xpath("/html/body/div[1]/nav/div[2]/ul/li[4]/a").click()

       # Edit a Student

       elem = driver.find_element_by_xpath("/html/body/div[1]/div/div/div/div/div/table/tbody/tr[1]/td[7]/a").click()
