...
class Test_OMK(unittest.TestCase):
    ...
    def test_omk_employee(self):
        ...
        driver.get("https://omk-2.herokuapp.com/emphome/")
        time.sleep(2)
        driver.get("https://omk-2.herokuapp.com/mentorlist/")
       # elem = driver.find_element_by_xpath(
        #    "/html/body/div/div/div/div/div/div/div[2]/table/tbody/tr[1]/td[7]/a").click()

        elem = driver.find_element_by_xpath(
                "/html/body/div[1]/div/div/div/div/div/table/tbody/tr[1]/td[7]/a").click()
        time.sleep(2)
